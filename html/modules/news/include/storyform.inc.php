...
$temp = new XoopsFormText(_NW_TITLE, 'title', 50, 255, $title);
...
if($op != 'edit' && $op != 'preview' && $op != 'form'){// by makinosuke @ 2009.1.10
	...
	$sform->addElement(new XoopsFormTextArea(_NW_THESCOOP, 'hometext', $hometext));// by makinosuke @ 2009.1.10
...
if($op != 'edit' && $op != 'preview' && $op != 'form'){// by makinosuke @ 2009.1.10
	...
	$sform->addElement(new XoopsFormTextArea(_AM_EXTEXT, 'bodytext', $bodytext));// by makinosuke @ 2009.1.10
}// by makinosuke @ 2009.1.10
