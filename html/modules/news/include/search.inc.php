<?php
// $Id: search.inc.php,v 1.5.1 2009/02/21 16:11:57 yoshis Exp $
//  ------------------------------------------------------------------------ //
...
function news_search($queryarray, $andor, $limit, $offset, $userid){
	...
	$highlight=false;
	$highlight=getmoduleoption('keywordshighlight');	// keywords highlighting
	...
	$i = 0;
 	while($myrow = $xoopsDB->fetchArray($result)){
		...
		if ($display) {
			...
			$ret[$i]['title'] = $myrow['topic_title'] .": ". $myrow['title'];
