...
/***************************************************************************
    ...
    Original source from : Let's PHP!¡Êhttp://php.s3.to/)

    $Id: thumb.php,v 1.0.2 2004/05/17 21:14:50 Y.Sakai Exp $
...
function thumb_create($src, $W, $H, $thumb_dir="./"){
  ...
  if (!$im_in) die(_NW_NOGDLIB);	// By Y.Sakai
  // Resize
