...
// ----------------------------------------------------------------------------
news_embed_markitup_bbcodeset = {
	markupSet: [
	{name:'Bold', key:'B', openWith:'[b]', closeWith:'[/b]', className:'pical-markitup-bold'},
	{name:'Italic', key:'I', openWith:'[i]', closeWith:'[/i]', className:'pical-markitup-italic'},
	{name:'Underline', key:'U', openWith:'[u]', closeWith:'[/u]', className:'pical-markitup-underline'},
	{name:'Delete', key:'D', openWith:'[d]', closeWith:'[/d]', className:'pical-markitup-delete'},
	{separator:'---------------' },
	{name:'Picture', key:'P', replaceWith:'[img][![Url]!][/img]', className:'pical-markitup-picture'},
	{name:'Link', key:'L', openWith:'[url=[![Url]!]]', closeWith:'[/url]', placeHolder:'Your text to link here...', className:'pical-markitup-link'},
	{separator:'---------------' },
	{name:'Colors', openWith:'[color=[![Color]!]]', closeWith:'[/color]', className:'pical-markitup-color', dropMenu: [
	...
	{name:'Size', key:'S', openWith:'[size=[![Text size]!]]', className:'pical-markitup-size', closeWith:'[/size]',
		dropMenu :[
	...
	//{separator:'---------------' },
	//{name:'Quotes', openWith:'[quote]', closeWith:'[/quote]', className:'pical-markitup-quote'},
	//{name:'Code', openWith:'[code]', closeWith:'[/code]', className:'pical-markitup-code'}, 
	{separator:'---------------' },
	{name:'Clean', className:"pical-markitup-clean", replaceWith:function(markitup) { return markitup.selection.replace(/\[(.*?)\]/g, "") } },
