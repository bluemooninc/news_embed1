<?php
// $Id: newsbythisauthor.php,v 1.8 2004/08/03 16:48:57 hthouzard Exp $
//  ------------------------------------------------------------------------ //
...
$xoopsTpl->assign('news_rating',getmoduleoption('ratenews'));
...
if($articlescount>0) {
	foreach ($articlelist as $article) {
		...
		$htmltitle='';
		if($infotips>0) {
			$htmltitle = ' title="'.make_infotips($article['hometext']).'"';
		}
